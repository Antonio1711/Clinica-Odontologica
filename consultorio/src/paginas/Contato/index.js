            ...
            <div className='contato-container'>
                <div className='contato-mapa'>
                    ...
                    <ul className='lista-medicos'>
                        ...
                        <li>
                            <img className='img-aparelho' src='assets/medico03.png' alt='Foto da Dra. Suzana' title='|Foto da Dra. Suzana' />
                            <p>Dra. Suzana</p>
                ...
                <div className='contato-mapa'>
                    ...
                    <p>R. Bento Branco de Andrade Filho, 379 - São Paulo - SP. CEP:049757-000</p>
                    <Mapa />
                </div>
            </div>
        </EstruturaPagina>

            ...
            <div className='home-apresentacao'>
                ...
                <ul className='lista-sobre-aparelho limitar-container'>
                    ...
                    <li>
                        ...
                        <p>Muitas pessoas não conseguem usar fio dental devido à posição da sua dentição. Contudo, a correção possibilita o cuidado com a saúde bucal de forma bem mais ampla.</p>
                    </li>
                    <li>
                ...
                <div className='home-depoimentos'>
                    <h2 className='titulo-sessao'>Veja o que nossos clientes estão falando...</h2>
                    <ul className='lista-depoimentos'>
                        ...
                        <li>
                            ...
                            <p>Eliana Torres</p>
                            <p>Meus dentes eram espaçados e depois de um ano estão no lugar certo.</p>
                        </li>
                        <li>
